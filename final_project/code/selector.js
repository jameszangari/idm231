...
function swapZodInfo(whichOne) {
  ...
  console.log('swapZodInfo called ' + whichOne);
    if        (whichOne == 1) {
      ...
      showMeDatesObj.textContent = "You are an Aries (March 21 - April 19)"
      ...
      showMeDatesObj.textContent = "You are a Taurus (April 20 – May 20)"
      ...
      showMeDatesObj.textContent = "You are a Gemini (May 21 – June 20)"
      ...
      showMeDatesObj.textContent = "You are a Cancer (June 21 – July 22)"
      ...
      showMeDatesObj.textContent = "You are a Leo (July 23 – August 22)"
      ...
      showMeDatesObj.textContent = "You are a Virgo (August 23 – September 22)"
      ...
      showMeDatesObj.textContent = "You are a Libra (September 23 – October 22)"
      ...
      showMeDatesObj.textContent = "You are a Scorpio (October 23 – November 21)"
      ...
      showMeDatesObj.textContent = "You are a Sagittarius (November 22 – December 21)"
      ...
      showMeDatesObj.textContent = "You are a Capricorn (December 22 – January 19)"
      ...
      showMeDatesObj.textContent = "You are an Aquarius (January 20 – February 18)"
      ...
      showMeDatesObj.textContent = "You are a Pisces (February 19 – March 20)"
